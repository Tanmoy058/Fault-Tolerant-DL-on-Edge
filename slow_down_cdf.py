...
def get_traj(test_type, pa, env, episode_max_length, pg_resume=None, ac_resume=None, render=False):
    """
...
def launch(pa, pg_resume=None, ac_resume=None, render=False, plot=False, repre='image', end='no_new_job'):
    ...
    for seq_idx in xrange(pa.num_ex):
        ...
        for test_type in test_types:
            ...
            rews, info = get_traj(test_type, pa, env, pa.episode_max_length, pg_resume, ac_resume)
    ...
    if plot:
        ...
        # plt.show()
        plt.savefig(pa.output_filename + "slowdown_fig" + ".pdf")
